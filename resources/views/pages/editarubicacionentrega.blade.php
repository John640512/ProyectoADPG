<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        <x-navbars.navs.auth titlePage="Editar Ubicación (Paso 1/2)"></x-navbars.navs.auth>
                            ...
                            <div class="col-md-8 mx-auto">
                                <div class="card shadow-lg">
                                    <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                        <h5 class="mb-0">
                                            <strong>Editar Datos del Negocio</strong>
                                        </h5>
                                        <div class="d-flex gap-2">
                                            <button type="submit" form="editForm" class="btn btn-outline-secondary btn-sm mb-0">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" 
                                            action="{{ route('actualizarubicacionentrega', $ubicacion->id_ubicacion_entrega) }}" 
                                            id="editForm">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade show active" id="datos" role="tabpanel">
                                                    ...
                                                    <div class="d-flex justify-content-between mt-4">
                                                        <a href="{{ route('editarmasdatosdeubicacionentrega', $ubicacion->id_ubicacion_entrega) }}" 
                                                            class="btn btn-primary">
                                                            <i class="material-icons" style="font-size: 1rem; vertical-align: middle;">arrow_forward</i>
                                                            Siguiente (Dirección)
                                                        </a>
                                                    </div>
                                                </div>
