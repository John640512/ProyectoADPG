<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Registrar Stock"></x-navbars.navs.auth>
        <!-- End Navbar -->
                            ...
                            <div class="col-md-10 mx-auto">
                                <div class="card shadow-lg">
                                    <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                        <h5 class="mb-0">
                                            <strong>Registro de Stock</strong>
                                        </h5>
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('stock') }}" id="stockForm">
                                            @csrf
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade show active" id="datos" role="tabpanel">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="datetime-local" class="form-control" name="fecha_llegada" required style="border: 2px solid #666; border-radius: 4px;">
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" step="0.01" class="form-control" name="cantidad_toneladas" required style="border: 2px solid #666; border-radius: 4px;">
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="id_producto" class="form-select border border-1 p-2" required>
                                                            ...
                                                            @foreach($productos as $productoItem)
                                                                <option value="{{ $productoItem->id_producto }}">
                                                                    {{ $productoItem->nombre }}
                                                                </option>
                                                            @endforeach
                                                        </select>
